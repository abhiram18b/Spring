package com.example.springboot.dataJpa.rest;

import com.example.springboot.dataJpa.entity.Employee;
import com.example.springboot.dataJpa.service.EmployeeService;
...
public class EmployeeRestController {
    ...
    public Employee patchEmployee(@PathVariable int employeeId,@RequestBody Map<String,Object> patchPayload){
        ...
        Employee updatedEmployeeInDB = employeeService.save(patchedEmployee);
